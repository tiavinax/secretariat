...
public class PaiementService {
    ...
    @Transactional
    public Paiement enregistrerPaiement(Integer inscriptionId,
            Integer echeanceId,
            BigDecimal montant,
            String modePaiement,
            String notes) {
        ...
        // Récupérer l'utilisateur connecté (le secrétaire)
        ...
        paiement.setSaisiPar(saisiPar);
        paiement.setCreatedAt(LocalDateTime.now());
        paiementRepository.save(paiement);

        // Vérifier si l'échéance est maintenant soldée
        BigDecimal montantAttendu = echeance.getMontantAttendu();

        // Calculer le total payé pour cette échéance spécifiquement
        BigDecimal totalEcheance = paiementRepository.findByEcheance(echeance)
                .stream()
                .map(Paiement::getMontant)
                .reduce(BigDecimal.ZERO, BigDecimal::add);

        if (totalEcheance.compareTo(montantAttendu) >= 0) {
    ...
    public byte[] exportPdf(BilanGlobalDTO bilan) throws Exception {
        ...
        // Polices
        com.itextpdf.text.Font fontTitre = new com.itextpdf.text.Font(com.itextpdf.text.Font.FontFamily.HELVETICA, 20,
                com.itextpdf.text.Font.BOLD, com.itextpdf.text.BaseColor.WHITE);
        com.itextpdf.text.Font fontSousTitre = new com.itextpdf.text.Font(com.itextpdf.text.Font.FontFamily.HELVETICA,
                10, com.itextpdf.text.Font.NORMAL, com.itextpdf.text.BaseColor.WHITE);
        com.itextpdf.text.Font fontSection = new com.itextpdf.text.Font(com.itextpdf.text.Font.FontFamily.HELVETICA, 12,
                com.itextpdf.text.Font.BOLD, vertFonce);
        com.itextpdf.text.Font fontEntete = new com.itextpdf.text.Font(com.itextpdf.text.Font.FontFamily.HELVETICA, 10,
                com.itextpdf.text.Font.BOLD, com.itextpdf.text.BaseColor.WHITE);
        ...
        com.itextpdf.text.Font fontBold = new com.itextpdf.text.Font(com.itextpdf.text.Font.FontFamily.HELVETICA, 10,
                com.itextpdf.text.Font.BOLD, com.itextpdf.text.BaseColor.DARK_GRAY);
        com.itextpdf.text.Font fontRouge = new com.itextpdf.text.Font(com.itextpdf.text.Font.FontFamily.HELVETICA, 10,
        ...
        com.itextpdf.text.Paragraph titrePara = new com.itextpdf.text.Paragraph("BILAN DES PAIEMENTS", fontTitre);
        ...
        for (BilanClasseDTO ligne : bilan.getLignes()) {
            ...
            table.addCell(cellule(ligne.getNomClasse(), fontBold, bg, com.itextpdf.text.Element.ALIGN_LEFT));
            ...
            table.addCell(cellule(String.valueOf(ligne.getNombreSoldes()), fontNormal, bg,
                    com.itextpdf.text.Element.ALIGN_CENTER));
            table.addCell(cellule(String.format("%.1f%%", pct), fontPct, bg, com.itextpdf.text.Element.ALIGN_CENTER));
        }
    ...
    public byte[] exportFacturePdf(Integer paiementId) throws Exception {
        ...
        // Polices
        com.itextpdf.text.Font fNomEcole = new com.itextpdf.text.Font(com.itextpdf.text.Font.FontFamily.HELVETICA, 16,
                com.itextpdf.text.Font.BOLD, vert);
        com.itextpdf.text.Font fAdresse = new com.itextpdf.text.Font(com.itextpdf.text.Font.FontFamily.HELVETICA, 8,
                com.itextpdf.text.Font.NORMAL, grisFonce);
        com.itextpdf.text.Font fTitreRecu = new com.itextpdf.text.Font(com.itextpdf.text.Font.FontFamily.HELVETICA, 14,
                com.itextpdf.text.Font.BOLD, com.itextpdf.text.BaseColor.WHITE);
        com.itextpdf.text.Font fNumero = new com.itextpdf.text.Font(com.itextpdf.text.Font.FontFamily.HELVETICA, 9,
                com.itextpdf.text.Font.NORMAL, com.itextpdf.text.BaseColor.WHITE);
        com.itextpdf.text.Font fSection = new com.itextpdf.text.Font(com.itextpdf.text.Font.FontFamily.HELVETICA, 9,
                com.itextpdf.text.Font.BOLD, vert);
        com.itextpdf.text.Font fLabel = new com.itextpdf.text.Font(com.itextpdf.text.Font.FontFamily.HELVETICA, 9,
                com.itextpdf.text.Font.NORMAL, grisFonce);
        com.itextpdf.text.Font fValeur = new com.itextpdf.text.Font(com.itextpdf.text.Font.FontFamily.HELVETICA, 9,
                com.itextpdf.text.Font.BOLD, com.itextpdf.text.BaseColor.BLACK);
        com.itextpdf.text.Font fMontant = new com.itextpdf.text.Font(com.itextpdf.text.Font.FontFamily.HELVETICA, 18,
                com.itextpdf.text.Font.BOLD, vert);
        com.itextpdf.text.Font fFooter = new com.itextpdf.text.Font(com.itextpdf.text.Font.FontFamily.HELVETICA, 7,
        ...
        try {
            ...
            com.itextpdf.text.pdf.PdfPCell lf = new com.itextpdf.text.pdf.PdfPCell(
                    new com.itextpdf.text.Phrase("E",
                            new com.itextpdf.text.Font(com.itextpdf.text.Font.FontFamily.HELVETICA, 28,
                                    com.itextpdf.text.Font.BOLD, com.itextpdf.text.BaseColor.WHITE)));
        ...
        ajouterLigneInfo(tableEleve, "Matricule", p.getInscription().getEtudiant().getMatricule(), fLabel, fValeur,
        ...
        ajouterLigneInfo(tableEleve, "Année scolaire", p.getInscription().getAnneeScolaire().getLibelle(), fLabel,
                fValeur, com.itextpdf.text.BaseColor.WHITE);
        doc.add(tableEleve);

        // ── DÉTAIL PAIEMENT ──
        com.itextpdf.text.Paragraph sectionPaiement = new com.itextpdf.text.Paragraph("DÉTAIL DU PAIEMENT", fSection);
        ...
        ajouterLigneInfo(tablePaiement, "Date limite", dateLimite, fLabel, fValeur, com.itextpdf.text.BaseColor.WHITE);
